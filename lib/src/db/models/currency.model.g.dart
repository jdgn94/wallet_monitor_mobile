...
Currency _currencyDeserialize(
  ...
  final object = Currency(
    ...
    symbol: reader.readString(offsets[1]),
  );
  return object;
}
...
extension CurrencyByIndex on IsarCollection<Currency> {
  Future<Currency?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  Currency? getByNameSync(String name) {
  ...
  Future<List<Currency?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<Currency?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(Currency object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(Currency object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<Currency> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<Currency> objects, {bool saveLinks = true}) {
...
extension CurrencyQueryWhere on QueryBuilder<Currency, Currency, QWhereClause> {
  ...
  QueryBuilder<Currency, Currency, QAfterWhereClause> nameEqualTo(String name) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Currency, Currency, QAfterWhereClause> nameNotEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
